...
def generate_forecast(
    ...
    scenarios = {
        ...
        "optimistic": {
            ...
            "p_loss": round(float(np.percentile(mc_p_losses, 25)), 1),
        ...
        "pessimistic": {
            ...
            "p_loss": round(float(np.percentile(mc_p_losses, 75)), 1),
            "probability": round(model_confidence * 0.6, 0),
        },
    }
    ...
    return {
        ...
        "confidence_intervals": {
            ...
            "p_loss": {
                "p10": round(float(np.percentile(mc_p_losses, 10)), 1),
                "p50": round(float(np.percentile(mc_p_losses, 50)), 1),
                "p90": round(float(np.percentile(mc_p_losses, 90)), 1),
            },
        },
        "scenarios": scenarios,
